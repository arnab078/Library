...
if(!$run)
{
  die("<script>alert('1 Book was not deleted. Please try again later');window.location.href='bl.php'</script>") ;
}
...
die("<script>alert('Book deleted successfully');window.location.href='bl.php'</script>") ;
?>
