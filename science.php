...
<div id="nav"> 
	...
	<div id="right">
		<h1 >Category</h1>
		 <a style="background-color: white; color: black;" href="science.php">Science</a><br><br>
	...
	<div id="left">
		...
		<?php
			$c="Science";
          	$q="select * from book where cotegary like '%$c%' LIMIT 3";
...
<center><a id="logout" href="science1.php"><button type="button">See more</button></a></center>
<center>
